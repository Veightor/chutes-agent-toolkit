...
Last updated: 2026-07-30 11:21 UTC

## Summary

- Models returned: **15**
- TEE/confidential-compute models: **15/15** — the hosted gateway is currently TEE-only.
- Models advertising `tools`: **13**
- Models advertising `json_mode`: **13**
- Models advertising `structured_outputs`: **13**
...
|---|---:|---:|---:|---:|---|---|---|---|---|
| `moonshotai/Kimi-K3-TEE` | 3 | 15 | 1.5 | 1049k | mxfp4 | sglang | yes | text+image+video | json_mode, structured_outputs, tools, reasoning |
| `zai-org/GLM-5.2-TEE` | 1.25 | 3.95 | 0.625 | 1049k | fp4 | sglang | yes | text | json_mode, structured_outputs, tools, reasoning |
