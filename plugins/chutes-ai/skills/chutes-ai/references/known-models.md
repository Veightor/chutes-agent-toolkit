...
| `Qwen/Qwen3.8-27B-TEE` | 0.4 | 3 | 0.04 | 262k | fp8 | vllm | yes | text+image | json_mode, tools, structured_outputs, reasoning |
...
- `Qwen/Qwen3.8-27B-TEE` ($0.4/$3, context 262k, text+image)
...
- `moonshotai/Kimi-K2.6-TEE` ($0.58/$3.4, context 262k, text+image+video)
